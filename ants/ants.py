...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        p = self.place
        dis = 0
        while p and p != beehive and dis <= self.max_range:
            if p.bees and dis >= self.min_range and dis <= self.max_range :
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.queen_id = QueenAnt.number_of_queen
    ...
    def action(self, gamestate):
        ...
        if self.queen_id != 1:
            ...
            while place != None:
                if place.ant:
                    if place.ant not in self.fellows:
                        self.fellows.add(place.ant)
                        place.ant.damage *= 2
                    if isinstance(place.ant, ContainerAnt) and place.ant.contained_ant:
                        if place.ant.contained_ant not in self.fellows:
                            self.fellows.add(place.ant.contained_ant)
